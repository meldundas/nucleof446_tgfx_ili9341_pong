...
//	Displ_WriteData((uint8_t *)"\x00",1,0);
//	/* GAMMA CURVE SELECTED */
//	Displ_WriteCommand(0x26); //Gamma set
//	Displ_WriteData((uint8_t *)"\x01",1,0); 	//Gamma Curve (G2.2)
//	//Positive Gamma  Correction
//	Displ_WriteCommand(0xE0);
//	Displ_WriteData((uint8_t *)"\x0f",1,0);
//	Displ_WriteData((uint8_t *)"\x31",1,0);
//	Displ_WriteData((uint8_t *)"\x2b",1,0);
//	Displ_WriteData((uint8_t *)"\x0c",1,0);
//	Displ_WriteData((uint8_t *)"\x0e",1,0);
//	Displ_WriteData((uint8_t *)"\x08",1,0);
//	Displ_WriteData((uint8_t *)"\x4e",1,0);
//	Displ_WriteData((uint8_t *)"\xf1",1,0);
//	Displ_WriteData((uint8_t *)"\x37",1,0);
//	Displ_WriteData((uint8_t *)"\x07",1,0);
//	Displ_WriteData((uint8_t *)"\x10",1,0);
//	Displ_WriteData((uint8_t *)"\x03",1,0);
//	Displ_WriteData((uint8_t *)"\x0e",1,0);
//	Displ_WriteData((uint8_t *)"\x09",1,0);
//	Displ_WriteData((uint8_t *)"\x00",1,0);
//	//Negative Gamma  Correction
//	Displ_WriteCommand(0xE1);
//	Displ_WriteData((uint8_t *)"\x00",1,0);
//	Displ_WriteData((uint8_t *)"\x0e",1,0);
//	Displ_WriteData((uint8_t *)"\x14",1,0);
//	Displ_WriteData((uint8_t *)"\x03",1,0);
//	Displ_WriteData((uint8_t *)"\x11",1,0);
//	Displ_WriteData((uint8_t *)"\x07",1,0);
//	Displ_WriteData((uint8_t *)"\x31",1,0);
//	Displ_WriteData((uint8_t *)"\xc1",1,0);
//	Displ_WriteData((uint8_t *)"\x48",1,0);
//	Displ_WriteData((uint8_t *)"\x08",1,0);
//	Displ_WriteData((uint8_t *)"\x0f",1,0);
//	Displ_WriteData((uint8_t *)"\x0c",1,0);
//	Displ_WriteData((uint8_t *)"\x31",1,0);
//	Displ_WriteData((uint8_t *)"\x36",1,0);
//	Displ_WriteData((uint8_t *)"\x0f",1,0);
